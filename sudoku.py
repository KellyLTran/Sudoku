    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN and main_menu:
            if IncrementW - 70 <= mouse[0] <= IncrementW + 70 and IncrementH - 25 <= mouse[1] <= IncrementH + 25:
                ...
                main_menu = False
                game_phase = True
            if IncrementW * 2 - 70 <= mouse[0] <= IncrementW * 2 + 70 and IncrementH - 25 <= mouse[
                1] <= IncrementH + 25:
                ...
                main_menu = False
                game_phase = True
            if IncrementW * 3 - 70 <= mouse[0] <= IncrementW * 3 + 70 and IncrementH - 25 <= mouse[
                1] <= IncrementH + 25:
        ...
        if game_phase:
            ...
            if width / 4 - 70 <= mouse[0] <= width / 4 + 70 and GameButtonHeight - 25 <= mouse[
            ...
            if width / 4 * 3 - 70 <= mouse[0] <= width / 4 * 3 + 70 and GameButtonHeight - 25 <= mouse[
                1] <= GameButtonHeight + 25:
